  ...
  return (
    <main className='bg-green-100 min-h-screen p-12'>
      <section className='container mx-auto'>
        ...
        <h2 className='text-lg text-gray-600 flex justify-center mb-12 mt-2'>Welcome to my Page of Blog Posts.</h2>
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
          ...
          <article>
            ...
            <span className='block h-64 relative rounded shadow leading-snug bg-white border-l-8 border-green-400' key={index}>
              ...
              <h3 className='text-gray-800 text-lg font-bold px-3 py-2 bg-red-700 bg-opacity-75 rounded'>{post.title}</h3>
              </span>
